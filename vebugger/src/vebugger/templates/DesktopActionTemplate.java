...
public class DesktopActionTemplate extends VebuggerTemplate {
	...
	private static final EnumMap<Action, String> ENABLED = new EnumMap<>(
			Action.class);
	private static final EnumMap<Action, String> DISABLED = new EnumMap<>(
			Action.class);
	static {
		ENABLED.put(
				Action.OPEN,
	...
	public void render(StringBuilder sb, Object obj) {
		...
		sb.append(
				"<style>.java-awt-Desktop-Action td {font-family: monospace; font-size: 0.7em; text-align: center;}")
